...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    public void onButtonClickSave(View v) {
        _impressionistView.saveDrawing();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
            Log.v(String.valueOf(RESULT_LOAD_IMAGE), "onError: "+ String.valueOf(RESULT_LOAD_IMAGE));
            Log.v(String.valueOf(REQUEST_IMAGE_CAPTURE), "onBlah: "+ String.valueOf(REQUEST_IMAGE_CAPTURE));
            ...
            try {
                ...
                ImageView imageView = (ImageView) findViewById(R.id.viewImage);
                _impressionistView.setImage(bitmap);
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE+2 && resultCode == RESULT_OK) {
            ...
            ImageView imageView = (ImageView) findViewById(R.id.viewImage);
            _impressionistView.setImage(imageBitmap);
